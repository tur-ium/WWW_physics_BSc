...
#TODO:
DONE: 28-12-17: Check results of shortestPath graphs are correct (cf. M Newman)
...
dataPath = 'test_data/network_fig10-1.csv'
...
networkx.draw(G,arrows=True,labels=labelDict)
