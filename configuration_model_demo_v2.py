...
#%%PARAMETERS
stepsize = 100
iterations = 20  #Number of iterations used for averaging
...
saveFile = 'empirical/Results/config-model_ResultsV={}N={}I={}_{}.csv'.format(V,N,iterations,timestamp)
...
def plot(label,n_list,l_av,l_unc,V,N,stepsize,iterations,c):
    ...
    ax2.set_title("Configurational Model: V={}, N={}, s={}, I={} {}".format(V,N,stepsize,iterations,label))
    ...
    ax3.set_title("Configurational Model: V={}, N={}, s={}, I={} {} s.d.".format(V,N,stepsize,iterations,label))
