...
def dataCollapse(LCS_ADD, LCS_REMOVE, ACC_ADD, ACC_REMOVE, collapseACC=True, collapseLCS=True):
     x = (np.array(list(range(len(AVG_LCS_ADD))))+1)*stepSize #1-1332 (Multiples of 50 (edges added))
...
LCS_ADD, LCS_REMOVE, ACC_ADD, ACC_REMOVE = collateData(noOfFiles=5)
